...
const Profile = ({ handleCloseOpenProfile, history }) => {
  ...
  return (
    <div className=" w-full h-full">
      <div className=" flex  items-center space-x-10 bg-[#550a0afa] text-white pt-16 px-10 pb-5">
        <BsArrowLeft
      ...
      <div className="px-3 my-5">
        <p className="py-10">
          this is not your username, this name will be visible to your Chunter-App
          contacts.
        </p>
      </div>
